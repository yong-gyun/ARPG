...
{0}
        ...
        public List<FileInfo> GetExcelFiles(string excelPath)
        {
        ...
        public List<DataTable> ConvertExcelToJson(string targetPath, string excelPath)
        {
            ...
            foreach (FileInfo fileInfo in GetExcelFiles(excelPath))
            {
        ...
        private void CreateJson(string targetPath, DataTable table)
        {
            ...
            for (int i = 0; i < datas.Count; i++)
            {
                ...
                result += string.Format(JSON_FORMAT, jsonData);
            }

            string jsonFormatter =
@"[{0}
]";
            Console.WriteLine($"Completed Write json data {path}");
